...
if ( !function_exists( 'poolservices_template_news_portfolio_theme_setup' ) ) {
	add_action( 'poolservices_action_before_init_theme', 'poolservices_template_news_portfolio_theme_setup', 1 );
	function poolservices_template_news_portfolio_theme_setup() {
		poolservices_add_template(array(
			'layout' => 'news-portfolio',
			'template' => 'news-portfolio',
			'mode'   => 'news',
			'title'  => esc_html__('Recent News /Style Portfolio/', 'poolservices'),
...
// Template output
if ( !function_exists( 'poolservices_template_news_portfolio_output' ) ) {
	function poolservices_template_news_portfolio_output($post_options, $post_data) {
